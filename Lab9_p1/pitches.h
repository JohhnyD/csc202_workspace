...
//-----------------------------------------------------------------------------
// DESCRIPTION
//    This header defines standard musical note frequencies (in Hz) for use
//    with tone-generating functions on microcontrollers. 
//
//    The notes are defined for octaves 0 through 8 using equal temperament 
//    tuning, with A4 set to 440 Hz as the reference pitch. The notes are 
//    spaced so that each step sounds evenly higher than the last. This means 
//    the same pattern of notes works well in all musical keys, making it easy
//    to play different songs without retuning the buzzer.
//
//    These definitions are suitable for passive buzzers, speakers, or any 
//    system requiring pitch-based frequency control.
//
//-----------------------------------------------------------------------------
// DISCLAIMER
